...
<div class="content-wrapper">
  ...
  @include('layouts._header-index', ['title' => 'order', 'iconClass' => 'fa-truck', 'addUrl' => '', 'multiLang' =>
  'false'])
          ...
          <div class="row">
                ...
                <select class="form-control select2 col-md-12" name="sender_city">
                    ...
                    @if(! empty($cities))
                        @foreach ($cities as $city)
                            <option  {{( ! empty($sender_city) && ($sender_city == $city->id))? 'selected' : ''}}  value="{{$city->id}}">{{$city->title }}</option>
                        @endforeach
                    @endif
            ...
            <div class="col-lg-3">
                ...
                <select class="form-control select2" name="receved_city">
                    ...
                    @if(! empty($cities))
                    @foreach ($cities as $city)
                        <option {{(! empty($receved_city) && ($receved_city == $city->id))? 'selected' : ''}}  value="{{$city->id}}">{{$city->title }}</option>
                    @endforeach
                    @endif
            ...
            <div class="tab-content col-md-12">
              <div id="menu1" class="tab-pane fade in active">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1_filter" class="data_table  datatable table table-bordered table-striped example1_filter">
                            <thead>
                            <tr>
                            ...
                            @foreach ($orders as $order)
                                <tr>
                                    ...
                                    <td>{{! empty($order->status) ? $order->status->title : '' }}</td>
                                    <td>
                                        @if($order->work_type==1)
                                        @if (in_array('show_order', $permissionsTitle))
                                            <a href="{{route('client-orders.show', $order->id)}}" title="View" class="btn btn-sm btn-warning"
...
<a href="{{route('client-orders.edit', $order->id)}}" title="pass order to delegate "
       class="btn btn-sm btn-primary" style="margin: 2px;"><i class="fa fa-truck"></i> <span
...
@endif
               ...
               <div id="menu2" class="tab-pane ">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example2_filter" class="data_table  datatable table table-bordered table-striped example1_filter">
                            <thead>
                            <tr>
                                <th><input type="checkbox" id="checkAll"></th>
                                <th>#</th>

    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="nav-tabs-custom">
                ...
                <div class="col-md-6">
                <form action="{{route('order.change_status')}}" method="POST">
                                ...
                                <tr>
                                 <td><input type="checkbox" name="orders[]" value="{{$order->id}}" class="ordersId"></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('/admin/order-notifications/'.$order->id)}}" class="btn btn-sm {{ $order->notification_no > 0 ? 'btn-warning' :'btn-default' }}" style="margin: 2px;"><i class="fa fa-bell"></i><span>({{$order->notification_no}})</span></a>
                                        @if($work_type==1)
                                        ...
                                        <br>
                                            ...
                                            <a href="{{route('client-orders.edit', $order->id)}}" title="View" class="btn btn-sm btn-info"

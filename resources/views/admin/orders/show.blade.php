        ...
        <div class="row">
            ...
            <div class="col-xs-6 printhidden" style="float:left">
                ...
                @if($order->status_id == 4 && !$order->is_returned)
                    <a class="btn btn-primary" href="{{ route('order.return',['order' => $order]) }}" target="_blank"> انشاء مرتجع طلب</a>
                @endif
            </div>
    ...
    <th>  {{$order->amount}}</th>
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                ...
                <a class="btn btn-info pull-right printhidden" href="{{route('client-orders.index')}}"><i

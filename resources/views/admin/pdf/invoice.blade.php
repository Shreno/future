                                ...
                                <td>
                                    ...
                                    <address
                                        ...
                                        <span style="font-size: 18px; line-height: 1.5; font-weight: 500;">
                                            {{$webSetting->title_ar}}</span></address>
                                </td>
                        ...
                        <tbody>
                            <tr style="padding: 28px 0; display:block;border-top: 1px solid rgba(82, 82, 108, 0.3);">
                                ...
                                <td Style="width:63%;"><span
                                        ...
                                        [4, (filter_var($amount, FILTER_SANITIZE_NUMBER_FLOAT,
                                        FILTER_FLAG_ALLOW_FRACTION) ) ],
                                        [5, (filter_var($client->tax, FILTER_SANITIZE_NUMBER_FLOAT,
                                        FILTER_FLAG_ALLOW_FRACTION) ) ]
                                        ];
                                ...
                                <td style="color: #52526C;opacity: 0.8; text-align:end;">
                                  ...
                                  <span
                                      style="display:block; line-height: 1.5; font-size:18px; font-weight:500;"> التفاصيل  
                                      :فاتورة تاريخ من  {{$invoice->start_date}} to {{$invoice->end_date}}</span>
                                  <span
                                      style="display:block; line-height: 1.5; font-size:18px; font-weight:500;">الرقم الضريبى
                                      : {{$client->tax_Number}}</span>
                                  
                              </td>
                                <td style="color: #52526C;opacity: 0.8; text-align:end;">
                                    <span
                                        style="display:block; line-height: 1.5; font-size:22px; font-weight:1000;">رقم الفاتورة :{{$invoice->InvoceNum}}
                                        </span>
                                    <span
                                        style="display:block; line-height: 1.5; font-size:18px; font-weight:500;">تاريخ الفاتورة 
                            ...
                            <tr
                                ...
                                <td style="padding: 18px 15px;display:flex;align-items: center;gap: 10px;">
                                    <ul style="padding: 0;margin: 0;list-style: none;">
                                        <li>
                                            <h4 style="font-weight:400; margin:4px 0px; font-size: 18px;">@if($client->work==1)
                                                                                                            شحنات طرود ناقل 
                                ...
                                <td style="padding: 18px 15px; width: 12%;"> <span style="font-size: 18px;">{{count($invoice->Invoice_order)}}</span>
                                </td>
                                <td style="padding: 18px 15px; width: 12%;"> <span
                                        style="font-size: 18px;">{{$client->tax}}%</span></td>
                                <td style="padding: 18px 15px; width: 10%;"> <span style="font-size: 18px;">{{$invoice->totaltax}}</span>
                                </td>
                                <td style="padding: 18px 15px;"><span style="font-size: 18px;">{{$invoice->Glopaltotal}}</span></td>
                            </tr>
                        ...
                        <tfoot>
                            ...
                            <td style="padding: 5px 0;text-align: left;padding-top: 15px;"><span
                                ...
                                <td style="padding: 5px 24px 5px 0; padding-top: 15px; text-align: end;"> <span
                                        ...
                                        style="margin-left: 8px; font-size: 18px;">:</span>حسابنا عبر بنك  </span></td>
                            ...
                            <td style="padding: 5px 0;text-align: left;padding-top: 0;"><span
                                ...
                                <td style="padding: 5px 24px 5px 0; text-align: end;"> <span
                                        style="color: #52526C; font-size: 18px; font-weight: 400;"><span style="margin-left: 8px; font-size: 18px;">:</span>الأيبان
                                        </span></td>

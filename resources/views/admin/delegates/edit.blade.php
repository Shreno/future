...
@endif
        ...
        <form action="{{route('delegates.update', $delegate->id)}}" method="POST" class="box  col-md-12"
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="">
                                        <input value="{{$delegate->manger_name}}" type="text" name="manger_name" class="form-control" id="manger_name"
                                            required>
                                        @error('manger_name')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="password" class="control-label"> مزود الخدمة
                                    </label>

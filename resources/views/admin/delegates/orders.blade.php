              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="{{route('client-orders.show', $order->id)}}" title="View" class="btn btn-sm btn-warning" style="margin: 2px;"><i class="fa fa-eye"></i> <span class="hidden-xs hidden-sm">View</span> </a>
                    <a href="{{route('client-orders.history', $order->id)}}" title="History" class="btn btn-sm btn-success" style="margin: 2px;"><i class="fa fa-history fa-spin"></i> <span class="hidden-xs hidden-sm">History</span> </a>
                    @endif
                    @if(in_array('distribution_order', $permissionsTitle))
                    <a href="{{route('comments.index', $order->id)}}" title="View" class="btn btn-sm btn-info" style="margin: 2px;"><i class="fa fa-commenting"></i> <span class="hidden-xs hidden-sm">comments</span> </a>
                    @endif

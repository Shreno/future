        ...
        <form action="{{route('appSettings.update')}}" method="post" enctype="multipart/form-data">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <!-- <li><a href="#Terms3" data-toggle="tab">شروط الخصوصية للمندوب متجر  </a></li>
              <li><a href="#Terms4" data-toggle="tab">شروط الخصوصية للمندوب المطعم  </a></li> -->
              ...
              <div class="tab-pane" id="Terms">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">شروط الخصوصية باللانجليزى</label>
                    <div class="form-group">
                <textarea class="textarea wysiwyg" name="terms_en" placeholder="Place some text here"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$settings->terms_en}}</textarea>
                    </div>
                </div>
                  <div class="form-group">
                  <label for="exampleInputEmail1">شروط الخصوصية بالعربى</label>
                    <div class="form-group">
                <textarea class="textarea wysiwyg" name="terms_ar" placeholder="Place some text here"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$settings->terms_ar}}</textarea>
                    </div>
                </div>

              </div>
              <!-- /.tab-pane -->
              <div class="tab-pane" id="Terms2">

<div class="form-group">
<label for="exampleInputEmail1">شروط الخصوصية باللانجليزى</label>
    <div class="form-group">
<textarea class="textarea wysiwyg" name="term_en_res" placeholder="Place some text here"
          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$settings->term_en_res}}</textarea>
    </div>
</div>
  <div class="form-group">
  <label for="exampleInputEmail1">شروط الخصوصية بالعربى</label>
    <div class="form-group">
<textarea class="textarea wysiwyg" name="term_ar_res" placeholder="Place some text here"
          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$settings->term_ar_res}}</textarea>
    </div>
</div>

</div>
<!-- /.tab-pane -->  <div class="tab-pane" id="Terms3">
              ...
              <!-- /.tab-pane -->  <div class="tab-pane" id="Terms4">

                <div class="form-group">
                <label for="exampleInputEmail1">شروط الخصوصية باللانجليزى</label>
                    <div class="form-group">
                <textarea class="textarea wysiwyg" name="term_en_d_2" placeholder="Place some text here"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$settings->term_en_d_2}}</textarea>
                    </div>
                </div>
                  <div class="form-group">
                  <label for="exampleInputEmail1">شروط الخصوصية بالعربى</label>
                    <div class="form-group">
                <textarea class="textarea wysiwyg" name="term_ar_d_2" placeholder="Place some text here"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$settings->term_ar_d_2}}</textarea>
                    </div>
                </div>

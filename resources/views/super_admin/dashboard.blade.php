      ...
      <div class="col-lg-4 col-xs-6">
        <!-- small box -->
         ...
         <div class="info-box  bg-red">
                ...
                <span class="info-box-number">{{\App\User::where('user_type', 'admin')->where('company_active','1')->count()}}</span>
                </div>
            </div>
      ...
      <div class="col-lg-4 col-xs-6">
        <!-- small box -->
          <div class="info-box  bg-green">
                ...
                <span class="info-box-number">{{\App\User::where('user_type', 'admin')->where('company_active','0')->count()}}</span>
                </div>
            </div>

...
<div class="content-wrapper">
  ...
  @include('layouts._header-form', ['title' => 'post', 'type' => 'Edit', 'iconClass' => 'fa fa-newspaper-o', 'url' =>
  route('posts.index'), 'multiLang' => 'true'])
      ...
      <form role="form" action="{{route('posts.update', $post->id)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="box-header with-border en">
                <h3 class="box-title "> post Title EN</h3>
              </div>
              <div class="box-header with-border ar">

                <h3 class="box-title "> post Title AR</h3>
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1">The title for your post</label>
                <input type="text" class="form-control en" id="title_en" name="title_en" id="exampleInputEmail1"
                  placeholder="title en" value="{{$post->title_en}}" required>
                <input type="text" class="form-control ar" name="title_ar" id="exampleInputEmail1"
                  placeholder="title ar" value="{{$post->title_ar}}" required>
              </div>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="box-header with-border">
                <h3 class="box-title en"> post Content en</h3>
                <h3 class="box-title ar"> post Content ar</h3>
              </div>
              <div class="form-group en">
                <textarea class="textarea wysiwyg" name="content_en" placeholder="Place some text here"
                  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$post->content_en}}</textarea>
              </div>
              <div class="form-group ar">
                <textarea class="textarea wysiwyg" name="content_ar" placeholder="Place some text here"
                  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$post->content_ar}}</textarea>
              </div>
            </div>
          </div>
          <div class="box box-primary">
            ...
            <div class="box-body">
              <div class="box-header with-border">
                <h3 class="box-title en"> Excerpt En </h3><span class="p">Small description of this post</span>
                <h3 class="box-title ar"> Excerpt Ar </h3><span class="p">Small description of this post</span>
              </div>
              <div class="form-group en">
                <textarea class="form-control" name="excerpt_en">{{$post->excerpt_en}}</textarea>

              </div>
              <div class="form-group ar">
                <textarea class="form-control" name="excerpt_ar">{{$post->excerpt_ar}}</textarea>
        ...
        <div class="col-md-5">
          <div class="box box-primary no-border">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <input type="text" id="slug" value="{{$post->slug}}" name="slug" class="form-control" id="exampleInputEmail1"
                  placeholder="slug">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="category_id" required>
                  ...
                  <option {{($post->category_id == $category->id)? 'selected' : ''}} value="{{$category->id}}">{{$category->title_en}} | {{$category->title_ar}}</option>
                  @endforeach
                </select>
          ...
          <div class="box box-primary no-border">
            ...
            <div class="box-body">
              <div class="form-group">
                <img src="{{asset('storage/'.$post->image)}}" height="250" width="100%" alt="">

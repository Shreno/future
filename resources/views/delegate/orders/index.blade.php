                            ...
                            @foreach ($orders as $order)
                                <tr>
                                    ...
                                    <td>{{$order->receved_name}}</td>
                                     <td>{{$order->receved_phone}} <a href="tel:{{$order->receved_phone}}" style="padding:5px"><i class="fa fa-phone fa-2x"></i></a> <a href="https://api.whatsapp.com/send?phone={{$order->receved_phone}}"  style="padding:5px"><i class="fa fa-whatsapp fa-2x" style="color:green"></i></a></td>
                                    <td>{{$order->amount}}</td>
                                    ...
                                    <td>{{$order->status->title}}</td>
                                        ...
                                        <a href="{{route('delegate-orders.edit', $order->id)}}" title="change Status" class="btn btn-sm btn-warning" style="margin: 2px;"><i class="fa fa-refresh"></i> <span class="hidden-xs hidden-sm">change Status</span> </a>
                                        @endif
                                          ...
                                          <a href="{{route('delegate-orders.show', $order->id)}}" title="View" class="btn btn-sm btn-info pull-right" style="margin: 2px;"><i class="fa fa-file-text-o"></i> <span class="hidden-xs hidden-sm">Show Policy</span> </a>
                                      </td>
                                    </tr>
                                <?php $count++ ?>
                            @endforeach
